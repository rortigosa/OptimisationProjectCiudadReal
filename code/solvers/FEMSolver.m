...
Optimisation.density_p           =  Optimisation.density.^Optimisation.penalty;
%--------------------------------------------------------------------------
...
switch TimeIntegrator.type
    ...
    case 'Static'
       switch NR.nonlinearity
           ...
           case 'arclength'
                [Solution,...
                   Optimisation]  =  IncrementalArcLength(Data,NR,Geometry,Mesh,UserDefinedFuncs,Bc,...
                                          FEM,Quadrature,MatInfo,Optimisation,...
                                          TimeIntegrator,'~',0);                                    
           case 'linearised_arclength'
                [Solution,...
                   Optimisation]  =  IncrementalLinearisedArcLength(Data,NR,Geometry,Mesh,UserDefinedFuncs,Bc,...
                                          FEM,Quadrature,MatInfo,Optimisation,...
                                          TimeIntegrator,'~',0);                                    

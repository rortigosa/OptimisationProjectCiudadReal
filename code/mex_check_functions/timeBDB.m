...
tic
for i=1:N
BDB    =  checkBDB_function(dim,ngauss,n_node_elem,BF,WFF,IntWeight);
end
toc
%--------------------------------------------------------------------------
...
tic
for i=1:N
BDB    =  checkBDB_function(str.geometry.dim,size(str.quadrature.volume.bilinear.W_v,1),str.mesh.volume.x.n_node_elem,BF,D2U.WFF,str.quadrature.volume.bilinear.W_v);
end
toc
%--------------------------------------------------------------------------

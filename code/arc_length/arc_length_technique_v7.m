function [str,incr_load]                       =  arc_length_technique_v7(str,incr_load)
...
while radius_convergence
      ...
      physics.Residual                         =  str.Residual.Residual(str.freedof);
      ...
      [solution,str]                           =  output_arclength_v7(physics,solution,str.arc_length.constraint_dof_u,Rw0_fixed,w0_fixed_residual,p0_fixed_residual,[0 0],total_u_fixed,str,0);
      ...
      while norm(Residual_norm)>tolerance          
          ...
          % Start arc length 
          %----------------------------------------------------------------
          [solution,str]                       =  output_arclength_v7(physics,solution,str.arc_length.constraint_dof_u,Rw0_fixed,...

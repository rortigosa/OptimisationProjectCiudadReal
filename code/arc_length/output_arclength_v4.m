function [solution,str]                         =  output_arclength_v4(physics,solution,constraint_dof_u,Rw0_fixed,w0_fixed_residual,p0_fixed_residual,sk,total_u_fixed,str,iteration)

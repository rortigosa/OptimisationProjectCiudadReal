...
/*-----------------------------------------------------------------------*/
template<>
void MooneyRivlin<4>(double mu1,
        double mu2,
        double lambda,
        const double *F_m,
        const double *H_m,
                  ...
                  int nrhs, const mxArray *prhs[])
{
    ...
    if (dim==2){
       ...
       for (igauss=0; igauss<ngauss; ++igauss){
           MooneyRivlin<4>(mu1,mu2,lambda,&F[dim*dim*igauss],&H[dim*dim*igauss],J[igauss],&P[dim*dim*igauss],&Elasticity[dim*dim*dim*dim*igauss]);
       }    
    }
}

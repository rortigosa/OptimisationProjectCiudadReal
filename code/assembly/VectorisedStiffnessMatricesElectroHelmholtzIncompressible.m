...
%--------------------------------------------------------------------------
%--------------------------------------------------------------------------
function  vectorised   =  VectorisedStiffnessMatricesElectroHelmholtzIncompressible(igauss,BFx,DN_X_phi,D2Psi,DPsi,pressure,...
...
geometric              =  (BFxT*QSigmaH*BFx) + (DPsi.DPsiDJ(igauss) + pressure(igauss))*(BFxT*BHx);

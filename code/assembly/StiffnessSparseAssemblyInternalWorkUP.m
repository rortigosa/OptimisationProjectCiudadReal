...
function [INDEXI,INDEXJ,...
            DATA]           =  StiffnessSparseAssemblyInternalWorkUP(ielement,dim,mesh,...
                                                                element_assembly)   
%--------------------------------------------------------------------------
% x dof's. 
%--------------------------------------------------------------------------
...
%--------------------------------------------------------------------------
INDEXI                      =  [Kxx_indexi;   Kxp_indexi;...
                                Kpx_indexi;   Kpp_indexi];
INDEXJ                      =  [Kxx_indexj;   Kxp_indexj;...
                                Kpx_indexj;   Kpp_indexj];
DATA                        =  [Kxx_data;     Kxp_data;...
                                Kpx_data;     Kpp_data];
end
function element_assembly  =  ParallelInternalWorkResidualStiffnessElectroIncompressible(ielem,quadrature,solution,geometry,mesh,fem,...
...
for igauss=1:ngauss
    ...
    %----------------------------------------------------------------------
    vectorised_matrices       =  VectorisedStiffnessMatricesElectroIncompressible(igauss,BF(:,:,igauss),DN_X_phi(:,:,igauss),...

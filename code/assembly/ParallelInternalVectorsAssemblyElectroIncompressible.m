function [INDEXI,...
  INDEXJ,DATA]   =  ParallelInternalVectorsAssemblyElectroIncompressible(ielement,dim,mesh,element_assembly)
...
global_p_dof     =  mesh.volume.pressure.connectivity(:,ielement)   + mesh.volume.x.n_nodes*dim + mesh.volume.phi.n_nodes;
%--------------------------------------------------------------------------
% INDEXI, INDEXJ, DATA
%--------------------------------------------------------------------------
INDEXI           =  [global_x_dof;...

function asmb      =  ParallelInternalWorkResidualStiffnessUCversion(ielem,quadrature,solution,geometry,mesh,fem,...
...
%--------------------------------------------------------------------------
[kinF,kinH,kinJ,...
    kinDNX,kinJacobian]  =  KinematicsFunctionVolumeCVersion(geometry.dim,ngauss,...
...
Piola_vect         =  Matrix2Vector(geometry.dim^2,ngauss,Piola);
%--------------------------------------------------------------------------
% Matrix BF    
%--------------------------------------------------------------------------

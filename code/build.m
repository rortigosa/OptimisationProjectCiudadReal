...
%         code_include  =  'C:\SoftwareDevelopment\MECHANICAL_SOLID_CODE_OPTIMISED\code\include';
        ...
        fastor_dir = fullfile(cdir,'code','include');
...
%         blas_path  =  'C:\Program Files\MATLAB\R2015b\extern\lib\win64\mingw64';
        ...
        compilation_instruction  = [compile ' -I"'  inc_dir '" -I"' code_dir '"  -I"' fastor_dir '" -L"' lib_dir '"' libraries ' -L"' blas_path '" ' blas_lib opt_flags];

...
figure(1)
subplot(2,2,1)
plot(str.mesh.volume.phi.nodes(1,inf_nodes),qinf,'-o')
title('Flux in lower surface')
subplot(2,2,2)
plot(str.mesh.volume.phi.nodes(1,sup_nodes),qsup,'-o')
title('Flux in upper surface')
subplot(2,2,3)
plot(str.mesh.volume.phi.nodes(2,left_nodes),qleft,'-o')
title('Flux in left surface')
subplot(2,2,4)
plot(str.mesh.volume.phi.nodes(2,right_nodes),qright,'-o')

...
function asmb          =  ResidualsMatricesUC(asmb,DU,D2U,Piola_vect,vect_kin,kinematics,IntWeight,dim,n_node_elem,ngauss)
...
for igauss=1:ngauss
    ...
    %----------------------------------------------------------------------
    asmb.Tx           =  asmb.Tx  +  (BFx'*Piola_vect(:,igauss))*IntWeight(igauss);

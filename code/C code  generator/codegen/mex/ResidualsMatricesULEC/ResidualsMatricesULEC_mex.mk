...
MAKEFILE = ResidualsMatricesULEC_mex.mk

include ResidualsMatricesULEC_mex.mki


SRC_FILES =  \
	ResidualsMatricesULEC_data.c \
	ResidualsMatricesULEC_initialize.c \
	ResidualsMatricesULEC_terminate.c \
	ResidualsMatricesULEC.c \
	mpower.c \
	_coder_ResidualsMatricesULEC_info.c \
	_coder_ResidualsMatricesULEC_api.c \
	_coder_ResidualsMatricesULEC_mex.c \
	ResidualsMatricesULEC_emxutil.c

MEX_FILE_NAME_WO_EXT = ResidualsMatricesULECMex
...
SYS_INCLUDE += -I "$(START_DIR)\codegen\mex\ResidualsMatricesULEC"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\ResidualsMatricesULEC/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\ResidualsMatricesULEC/%.cu
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\ResidualsMatricesULEC/%.cpp
	$(CXX) $(CPPFLAGS) "$<"

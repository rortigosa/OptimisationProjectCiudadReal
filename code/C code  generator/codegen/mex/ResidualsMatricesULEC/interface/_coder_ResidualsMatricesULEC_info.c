 ...
 *
 * Code generation for function '_coder_ResidualsMatricesULEC_info'
 *
 */
...
#include "_coder_ResidualsMatricesULEC_info.h"
...
static void info_helper(const mxArray **info)
{
  ...
  emlrtAddField(*info, emlrt_marshallOut(
    "[E]C:/SoftwareDevelopment/OPTIMISATION_CODE/code/C code  generator/ResidualsMatricesULEC.m"),
                "context", 0);
...
mxArray *emlrtMexFcnProperties(void)
{
  ...
  emlrtSetField(xEntryPoints, 0, "Name", mxCreateString("ResidualsMatricesULEC"));
...
/* End of code generation (_coder_ResidualsMatricesULEC_info.c) */

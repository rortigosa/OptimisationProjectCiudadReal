...
#include "blas.h"
#include "StiffnessMatrixUFormulation.h"
/*-----------------------------------------------------------------------*/
/*-----------------------------------------------------------------------*/
/* The C function */
/*-----------------------------------------------------------------------*/
                  ...
                  int nrhs, const mxArray *prhs[])
{
    ...
    double *BH;               /* input matrix */
    double *BJ;               /* input matrix */
    double *GeomSigmaH;       /* input matrix */
    double *WFF;              /* input matrix */
    double *WFH;              /* input matrix */
    double *WFJ;              /* input matrix */
    double *WHH;              /* input matrix */
    double *WHJ;              /* input matrix */
    double *WJJ;              /* input matrix */
    double *SigmaJ;           /* input matrix */
    ...
    WHJ                 =  mxGetPr(prhs[11]);
    WJJ                 =  mxGetPr(prhs[12]);
    SigmaJ              =  mxGetPr(prhs[13]);
    IntWeight           =  mxGetPr(prhs[14]);
    /*-------------------------------------------------------------------*/
    ...
    /*-------------------------------------------------------------------*/
    perfomer((mwSize)dim,(mwSize)n_gauss,(mwSize)n_node_elem,BF,BH,BJ,GeomSigmaH,WFF,WFH,KFJ,WHH,KHJ,KJJ,SigmaJ,IntWeight,K);
}

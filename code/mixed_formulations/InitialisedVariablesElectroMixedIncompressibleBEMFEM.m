function solution                   =  InitialisedVariablesElectroMixedIncompressibleBEMFEM(geom,mesh,material_information)
...
solution.Sigmad                            =  zeros(3,mesh.volume.Sigmad.n_nodes);
...
for ielem=1:mesh.volume.n_elem
    ...
    solution.Sigmad(:,dnodes)              =  Matrix2Vector(geom.dim^2,n_node_elem_d,Sigmad);
end
%--------------------------------------------------------------------------

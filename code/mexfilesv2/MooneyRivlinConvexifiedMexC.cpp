        ...
        double *Elasticity_m)
{
    ...
    Tensor<double,ndim,ndim> Fx0;
    Tensor<double,ndim,ndim> Hx0;
    copy_matlab(F,F_m);
    copy_matlab(H,H_m);
    copy_matlab(Fx0,Fx0_m);
    copy_matlab(Hx0,Hx0_m);
    double J = J_m;
    /*-------------------------------------------------------------------*/    
    ...
    /*-------------------------------------------------------------------*/
    Tensor<double,ndim,ndim> P   =  WF + WJ*Hx0;    
    /*-------------------------------------------------------------------*/    
    ...
    Tensor<double,ndim,ndim,ndim,ndim> H_H  =  outer(Hx0,Hx0);        
                  ...
                  int nrhs, const mxArray *prhs[])
{
    ...
    if (dim==2){
       for (igauss=0; igauss<ngauss; ++igauss){
           MooneyRivlin<2>(mu1,mu2,lambda,&F[dim*dim*igauss],&H[dim*dim*igauss],J[igauss],&Fx0[dim*dim*igauss],&Hx0[dim*dim*igauss],&P[dim*dim*igauss],&Elasticity[dim*dim*dim*dim*igauss]);
       }
    }
    else if (dim==3){
       for (igauss=0; igauss<ngauss; ++igauss){
           MooneyRivlin<3>(mu1,mu2,lambda,&F[dim*dim*igauss],&H[dim*dim*igauss],J[igauss],&Fx0[dim*dim*igauss],&Hx0[dim*dim*igauss],&P[dim*dim*igauss],&Elasticity[dim*dim*dim*dim*igauss]);
       }    
    }
}

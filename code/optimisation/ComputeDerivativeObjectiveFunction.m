...
function DIDrho    =  ComputeDerivativeObjectiveFunction(p,Mesh,Optimisation,...
    Solution,MatInfo,Geometry,NR,FEM,Quadrature,ObjFunc0,TimeIntegrator,StabilisationFactor)
...
elseif strcmp(NR.nonlinearity,'nonlinear') || strcmp(NR.nonlinearity,'arclength')
    %----------------------------------------------------------------------
    % Stable solutions
    %----------------------------------------------------------------------
    DIDrho =  DerivativeObjectiveFunctionMexFiles(p,Mesh,Optimisation,...
                                 Solution,Geometry,FEM,Quadrature,MatInfo);    
elseif strcmp(NR.nonlinearity,'linearised_arclength')
    %----------------------------------------------------------------------
    % Stable solutions
    %----------------------------------------------------------------------
    DIDrho =  DerivativeObjectiveFunctionMexFiles(p,Mesh,Optimisation,...
...
%                            Mesh,Optimisation,Solution,MatInfo,Geometry,...
%                            FEM,Quadrature);    
%    DIDrho   =  DerivativeObjectiveFunctionNonlinearConvexifiedMexFilesV2(p,...
%                            Mesh,Optimisation,Solution,MatInfo,Geometry,...
%                            FEM,Quadrature,StabilisationFactor);    
    DIDrho =  DerivativeObjectiveFunctionMexFiles(p,Mesh,Optimisation,...
                                 Solution,Geometry,FEM,Quadrature,MatInfo);    
end
    %----------------------------------------------------------------------
